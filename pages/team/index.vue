    ...
    <LocomotiveScroll ref="scroller" :getted-options="scrollOptions">
      <div class="team d-md-flex h-100 next-page-offset">
        <div class="gallery d-md-flex h-100 py-32" data-scroll-section data-scroll-trigger>
          <div v-for="(type, index) in types" :key="index" class="gallery d-md-flex h-100 py-32">
...
export default {
  ...
  async asyncData({ $axios }) {
    ...
    const types = ['main', 'secondary', 'management'];
    const titles = {
      main: { title: 'გუნდი', text: 'lorem ...' },
      secondary: { title: 'ახალგაზრდული', text: 'lorem ...' },
  ...
  data() {
    return {
      types: ['main', 'secondary', 'management'],
      titles: {
        main: { title: 'გუნდი', text: '' },
        secondary: { title: 'ახალგაზრდული', text: '' },
        management: { title: 'მენეჯმენტი', text: '' },
      },
      team: {},
      players: [],
      scrollOptions: {
